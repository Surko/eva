...
import static evolution.operators.AdaptiveMutationUnBiased.index;
import static evolution.operators.AdaptiveMutationUnBiased.maxindex;
 ...
 * @author kirrie
 */
public class AdaptiveMutationBiased implements Operator {
    
    double mutationProbability;
    double geneChangeProbability;
    RandomNumberGenerator rng = RandomNumberGenerator.getInstance();
    private double sigma = 1,mean = 0;
    RealFunction rf;
    ...
    public AdaptiveMutationBiased(double mutationProbability, double geneChangeProbability,  double mean,double sigma, RealFunction rf) {        
